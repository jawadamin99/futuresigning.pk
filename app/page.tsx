...
const categories = [
  { name: "Corporate Gift Boxes", type: "Curated branded sets", copy: "Presentation boxes built around the occasion, audience and budget—not an off-the-shelf bundle.", image: "/images/catalogue/black-presentation-set.png", interest: "Corporate gift boxes", details: ["Client gifting", "Festive campaigns"] },
  { name: "Employee Onboarding Kits", type: "Welcome & culture", copy: "Coordinated first-day kits with useful branded products for new team members.", image: "/images/catalogue/red-welcome-kit.png", interest: "Employee onboarding kits", details: ["New joiners", "Team welcome"] },
  { name: "Customized Coffee Mugs", type: "Everyday visibility", copy: "Ceramic coffee mugs customized with your logo, campaign artwork or employee identity.", image: "/images/catalogue/black-mug.png", interest: "Customized coffee mugs", details: ["Office use", "Giveaways"] },
  { name: "Customized Water Bottles", type: "Branded hydration", copy: "Premium insulated bottles customized for teams, campaigns and everyday brand visibility.", image: "/images/catalogue/wooden-bottle.png", interest: "Customized water bottles", details: ["Insulated bottles", "Premium finishes"] },
  { name: "Travel Mugs & Tumblers", type: "Premium drinkware", copy: "Insulated metal drinkware for executives, travelling teams and thoughtful corporate gifts.", image: "/images/catalogue/black-travel-mug.png", interest: "Metal coffee mugs & tumblers", details: ["Executive gifts", "Daily commute"] },
  { name: "Power Banks & Charging Accessories", type: "Useful technology", copy: "Wireless charging wallets, USB products and multi-connector accessories for modern workdays.", image: "/images/catalogue/charging-wallet.png", interest: "Power banks & charging accessories", details: ["Travel kits", "Tech gifting"] },
  { name: "Customized Metal Pens", type: "Professional stationery", copy: "Metal pens and boxed writing instruments finished for meetings, gifting and daily brand presence.", image: "/images/catalogue/executive-pen.png", interest: "Customized metal pens", details: ["Executive desks", "Conferences"] },
  { name: "Customized Keychains", type: "Compact brand pieces", copy: "Metal and leather keychains developed as practical giveaways or additions to a larger gift set.", image: "/images/catalogue/leather-keychain.png", interest: "Customized keychains", details: ["Giveaways", "Gift-box inserts"] },
  { name: "Notebooks & Diaries", type: "Branded stationery", copy: "Spiral notebooks, hardbound diaries and writing sets prepared for teams, events and clients.", image: "/images/catalogue/spiral-notebook.png", interest: "Notebooks & diaries", details: ["Onboarding", "Corporate events"] },
  { name: "Premium Desk & Event Products", type: "Beyond the usual", copy: "Card holders, coasters, mini fans, table flags and other distinctive products for your brief.", image: "/images/catalogue/card-holder.png", interest: "Desk & event products", details: ["Desk pieces", "Event merchandise"] },
  { name: "Custom USB Flash Drives", type: "Portable technology", copy: "Compact branded storage products for conferences, sales teams and company resources.", image: "/images/catalogue/usb-drive.png", interest: "Custom USB flash drives", details: ["Conferences", "Digital handovers"] },
  { name: "Multi-Charging Cables", type: "Useful giveaways", copy: "Practical multi-connector charging accessories made for modern desks, travel and events.", image: "/images/catalogue/charging-cable.png", interest: "Multi-charging cables", details: ["Tech giveaways", "Travel kits"] },
  { name: "Leather Desk Accessories", type: "Premium office pieces", copy: "Branded coasters and coordinated leather accessories for executive desks and client gifting.", image: "/images/catalogue/leather-coasters.png", interest: "Leather desk accessories", details: ["Executive desks", "Client gifts"] },
  { name: "Corporate Wallets & Card Holders", type: "Everyday business essentials", copy: "Slim professional accessories customized for teams, delegates and curated gift sets.", image: "/images/catalogue/black-wallet.png", interest: "Corporate wallets and card holders", details: ["Team essentials", "Gift-box inserts"] },
  { name: "Promotional Mini Fans", type: "Distinctive event products", copy: "Portable branded fans that give warm-weather campaigns and events a useful point of difference.", image: "/images/catalogue/mini-fan.png", interest: "Promotional mini fans", details: ["Summer campaigns", "Event giveaways"] },
  { name: "Custom Table Flags", type: "Corporate display", copy: "Branded desk and table flags prepared for offices, conferences, ceremonies and formal events.", image: "/images/catalogue/table-flags.png", interest: "Custom table flags", details: ["Corporate offices", "Formal events"] },
] as const;
...
export default function Home() {
  return <>
    ...
    <main id="main">
      ...
      <section className="products-section section-space" id="products"><div className="shell"><SectionIntro eyebrow="Your brand, imprinted on everything" title="Products ready for your identity." copy="Choose a starting point. We will advise the suitable product, branding method and production route around your quantity, budget and deadline." /><div className="category-grid">{categories.map((item, index) => <article className={`category-card category-card--${index + 1}`} key={item.name}><div className="category-image"><Image src={item.image} alt={`${item.name} by Future Signing`} fill sizes="(max-width: 700px) 92vw, (max-width: 1050px) 45vw, 30vw" /></div><div className="category-copy"><small>{item.type}</small><span>{item.name}</span><p>{item.copy}</p><div className="category-details" aria-label={`Popular uses for ${item.name}`}>{item.details.map((detail) => <b key={detail}>{detail}</b>)}</div><a href="#contact" data-interest={item.interest} aria-label={`Enquire about ${item.name}`}>Customize this product <ArrowUpRight /></a></div></article>)}</div><p className="product-close">Your brand, <em>imprinted on everything.</em></p></div></section>
